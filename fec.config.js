module.exports = {
  appUrl: '/subscriptions/workspaces',
  debug: true,
  useProxy: true,
  proxyVerbose: true,
  /**
   ...
   */
  sassPrefix: '.composer-ui, .composerUi',
  /**
  ...
  moduleFederation: {
    exposes: {
      ...
      './frontendModules/useFedModulesStore': './src/hooks/sharedStores/useFedModulesStore',
      './frontendModules/useFedModulesFilter': './src/hooks/sharedStores/useFedModulesFilter'
    },
    shared: []
  }
};
